    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            children: [
              Image.asset(Images.google, height: 40),
              SizedBox(
                width: 30,
              ),
              Column(
          ...
          Row(
            children: [
              _headerStatic("Min Salary", "\5000000 LPA"),
              _headerStatic("Applicants", "247"),
              _headerStatic("Max Salary", "\7000000 LPA"),
            ],
          ),
          SizedBox(height: 40),
          Row(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          Text(
              "As a Software Engineer at Google, you will be responsible for developing and implementing high-quality software solutions to solve complex problems. You will work closely with cross-functional teams, including product managers, designers, and other engineers, to design and develop scalable and efficient software systems." ,
        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                _people(context, img: Images.user1, name: "Utsav"),
                _people(context, img: Images.user2, name: "Sonali"),
                _people(context, img: Images.user3, name: "Priyanka"),
                _people(context, img: Images.user4, name: "John"),
                _people(context, img: Images.user5, name: "Tom"),
                _people(context, img: Images.user6, name: "Jordan"),
              ],
            ),
          ),
        ],
